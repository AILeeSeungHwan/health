const post = {
  id: 'P0001',
  sections: [
    { type: 'intro', html: '<p><strong>한눈에 보기:</strong> 닭가슴살 소시지는 100g 당 단백질 14~20g, 지방 1~4g 수준의 고단백·저지방 가공식품으로, 다이어트·근육 유지·간편한 단백질 보충용으로 자주 활용됩니다.</p><p>다만 가공육 분류이므로 나트륨·식품첨가물 함량을 반드시 확인해야 하고, 자연 식재료(생닭가슴살·계란·생선)와 병행하는 균형이 중요합니다. 이 글은 영양 성분 비교 기준, 목적별 선택 가이드, 조리법, 주의해야 할 라벨 항목까지 정리합니다.</p>' },    { type: 'toc' },

    { type: 'callout', html: "<p>다이어트 중에 닭가슴살 소시지를 매일 먹었다. 나중에 나트륨 함량을 보니 제품마다 차이가 컸다. 저칼로리라고 무조건 건강식이 아니라는 걸 그때 깨달았다. 성분표를 보는 습관은 닭가슴살 소시지 때부터 생겼다.</p>" },
