...
const post = {
  id: 'G0003',
  sections: [
    { type: 'intro', html: '<p><strong>일반의약품(OTC)은 처방 없이 구입할 수 있지만 안전한 것과는 다릅니다.</strong> 잘못된 중복 복용, 모르고 하는 약물 상호작용, 음식·음료와의 조합이 예상치 못한 부작용을 일으킬 수 있습니다. 이 가이드는 가정에서 가장 많이 쓰는 OTC 계열별로 안전 복용 원칙과 피해야 할 조합을 정리합니다.</p>' },
    { type: 'toc' },
