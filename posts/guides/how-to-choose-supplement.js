const post = {
  id: 'G0001',
  sections: [
    { type: 'intro', html: '<p>영양제는 마법이 아닙니다. 식사와 생활습관의 <strong>보조</strong>이고, 잘못 고르면 돈 낭비와 상호작용 위험이 됩니다. 성분·인증·상호작용·가격 대비 품질을 단계별로 점검하는 법을 정리합니다.</p>' },    { type: 'toc' },

    { type: 'callout', html: "<p>영양제를 처음 살 때는 광고 보고 샀다. 효과도 없고 돈만 날린 경험이 있다. 나중에 식약처 인정 기능성 원료가 뭔지, 함량이 충분한지 보는 법을 익히고 나서 선택 기준이 달라졌다. 좋은 영양제를 고르는 건 라벨 읽는 법을 아는 것부터다.</p>" },
