const post = {
  id: 'S0002',
  sections: [
    { type: 'intro', html: '<p><strong>한눈에 보기:</strong> 편두통은 한쪽 머리가 박동성으로 4~72시간 지속되고, 빛·소리 민감·메스꺼움을 동반하는 1차성 두통입니다. 급성기는 조기 진통제와 환경 조절이 핵심이고, 잦은 경우에는 예방적 관리가 필요합니다.</p>' },    { type: 'toc' },

    { type: 'callout', html: "<p>눈앞에 반짝이는 게 보이고 시야 한쪽이 잘 안 보이는 경험을 처음 했을 때 눈 문제인 줄 알았다. 나중에 편두통 전조 증상이라는 걸 알고 나서는 그 신호가 오면 바로 어두운 곳에 눕는다. 전조를 알면 골든 타임이 생긴다.</p>" },

    { type: 'image', src: '/thumbnails/symptoms/migraine.svg', alt: '편두통 — 전조증상 알면 골든타임이 생긴다', caption: '편두통 완전 가이드' },
