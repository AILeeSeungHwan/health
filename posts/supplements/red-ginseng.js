// posts/supplements/red-ginseng.js
const post = {
  id: 'U0005',
  sections: [
    {
    ...
    { type: 'callout', html: "<p>피로가 쌓이는 시기마다 홍삼을 찾게 된다. 즉각적인 효과가 느껴지진 않는데도 계속 먹게 되는 건 오랜 기간 쓰인 것에 대한 신뢰감 때문인 것 같다. 식약처 인정 기능성이 6가지나 된다는 건 나중에 알았다. 제품마다 진세노사이드 함량이 다르다는 것도.</p>" },
