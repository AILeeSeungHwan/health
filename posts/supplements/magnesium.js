const post = {
  id: 'U0002',
  sections: [
    { type: 'intro', html: '<p><strong>한눈에 보기:</strong> 마그네슘은 우리 몸에서 300종 이상의 효소 반응에 관여하는 필수 미네랄입니다. 신경·근육 기능, 에너지 생성, 뼈 형성에 필요하며 식약처가 인정한 기능성 원료입니다.</p><p>한국인 영양소 섭취 기준에 따르면 성인 남성 350mg, 여성 280mg이 권장되지만, 가공식품 위주 식단·잦은 외식·과도한 카페인·알코올 섭취가 결핍을 부추깁니다. 이 글은 마그네슘의 식약처 인정 기능성, 형태별 흡수 차이, 복용 시점, 부작용·상호작용, 식품 대체까지 정리합니다.</p>' },    { type: 'toc' },

    { type: 'callout', html: "<p>만성 편두통이 있었다. 여러 가지를 시도해봤는데 마그네슘을 3개월 꾸준히 먹으면서 두통 빈도가 줄었다. 편두통과 마그네슘의 연관성에 대한 연구가 생각보다 많다는 걸 그때 알았다. 잠들기 전에 먹으면 수면에도 도움이 된다는 건 체감이 됐다.</p>" },
