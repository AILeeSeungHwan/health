...
const post = {
  ...
  sections: [
    ...
    { type: 'callout', html: "<p>하루 10시간 이상 모니터를 보는 생활을 10년 넘게 했다. 눈이 피로하면 시야 중심이 흐릿해지는 느낌이 있었다. 루테인을 먹기 시작한 건 그 불편함 때문이었다. 나이 들수록 황반을 보호하는 게 중요하다는 걸 알고 나서는 계속 챙기는 영양제 중 하나가 됐다.</p>" },
