const post = {
  id: 'U0001',
  sections: [
    { type: 'intro', html: '<p><strong>한눈에 보기:</strong> 오메가3(EPA+DHA)는 식약처가 인정한 건강기능식품으로 혈중 중성지질 개선·혈행 개선·건조한 눈·기억력 개선 기능성이 있습니다. 항응고제 복용자·수술 예정자는 의료 상담이 필요합니다.</p>' },    { type: 'toc' },

    { type: 'callout', html: "<p>중성지질이 높다는 건강검진 결과를 받고 오메가3를 먹기 시작했다. 반신반의하면서 6개월을 먹었는데 재검 수치가 내려갔다. 물론 식단도 함께 바꿨지만 — 오메가3가 도움이 된다는 느낌은 있었다. 고등어를 자주 먹지 않는 사람이라면 챙겨볼 만하다.</p>" },
