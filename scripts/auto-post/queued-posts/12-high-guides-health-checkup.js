...
// entity: guides | slug: health-checkup-guide | priority: high | slot: morning
'use strict'

module.exports = {
  meta: { entity: 'guides', dataId: 'G0004', slug: 'health-checkup-guide', priority: 'high', slot: 'morning' },
  ...
  postContent: `// posts/guides/health-checkup-guide.js
const post = {
  id: 'G0004',
  sections: [
    {
