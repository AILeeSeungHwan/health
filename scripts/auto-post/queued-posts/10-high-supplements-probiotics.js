...
// entity: supplements | slug: probiotics | priority: high | slot: noon
'use strict'

module.exports = {
  meta: { entity: 'supplements', dataId: 'U0006', slug: 'probiotics', priority: 'high', slot: 'noon' },
  ...
  postContent: `// posts/supplements/probiotics.js
const post = {
  id: 'U0006',
  sections: [
    {
