...
// entity: symptoms | slug: menopause-symptoms | priority: high | slot: morning
'use strict'

module.exports = {
  meta: { entity: 'symptoms', dataId: 'S0011', slug: 'menopause-symptoms', priority: 'high', slot: 'morning' },
  ...
  dataEntry: {
    ...
    symptomName: '갱년기 증상',
    nameEn: 'Menopause Symptoms',
    bodyPart: 'endocrine',
    severity: 'medium',
    hasEmergency: false,
    relatedOtc: [],
    relatedSupplements: ['calcium-vit-d', 'red-ginseng', 'iron'],
    relatedSituation: null,
    relatedTool: null,
    relatedSlugs: [],
  },

  postContent: `// posts/symptoms/menopause-symptoms.js
const post = {
  id: 'S0011',
  sections: [
    {
