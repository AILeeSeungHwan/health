...
// entity: symptoms | slug: frozen-shoulder | priority: high | slot: morning
'use strict'

module.exports = {
  meta: { entity: 'symptoms', dataId: 'S0010', slug: 'frozen-shoulder', priority: 'high', slot: 'morning' },
  ...
  dataEntry: {
    ...
    symptomName: '오십견(유착성 관절낭염)',
    nameEn: 'Frozen Shoulder (Adhesive Capsulitis)',
    bodyPart: 'shoulder',
    severity: 'medium',
    hasEmergency: false,
    relatedOtc: ['ibuprofen'],
    relatedSupplements: ['omega-3', 'vitamin-d'],
    relatedSituation: null,
    relatedTool: null,
    relatedSlugs: ['shoulder-pain'],
  },

  postContent: `// posts/symptoms/frozen-shoulder.js
const post = {
  id: 'S0010',
  sections: [
    {
