...
// entity: symptoms | slug: shoulder-pain | priority: high | slot: morning
'use strict'

module.exports = {
  meta: { entity: 'symptoms', dataId: 'S0008', slug: 'shoulder-pain', priority: 'high', slot: 'morning' },
  ...
  postContent: `// posts/symptoms/shoulder-pain.js
const post = {
  id: 'S0008',
  sections: [
    {
