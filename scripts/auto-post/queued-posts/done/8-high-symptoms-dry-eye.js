...
// entity: symptoms | slug: dry-eye | priority: high | slot: morning
'use strict'

module.exports = {
  meta: { entity: 'symptoms', dataId: 'S0013', slug: 'dry-eye', priority: 'high', slot: 'morning' },
  ...
  dataEntry: {
    ...
    symptomName: '안구건조증',
    nameEn: 'Dry Eye Disease (DED)',
    bodyPart: 'eye',
    severity: 'low',
    hasEmergency: false,
    relatedOtc: [],
    relatedSupplements: ['lutein', 'omega-3'],
    relatedSituation: 'eye-strain',
    relatedTool: null,
    relatedSlugs: [],
  },

  postContent: `// posts/symptoms/dry-eye.js
const post = {
  id: 'S0013',
  sections: [
    {
