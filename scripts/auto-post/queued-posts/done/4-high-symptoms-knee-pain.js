...
// entity: symptoms | slug: knee-pain | priority: high | slot: morning
'use strict'

module.exports = {
  meta: { entity: 'symptoms', dataId: 'S0009', slug: 'knee-pain', priority: 'high', slot: 'morning' },
  ...
  postContent: `// posts/symptoms/knee-pain.js
const post = {
  id: 'S0009',
  sections: [
    {
