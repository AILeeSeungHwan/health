...
// entity: symptoms | slug: hair-loss | priority: high | slot: morning
'use strict'

module.exports = {
  meta: { entity: 'symptoms', dataId: 'S0012', slug: 'hair-loss', priority: 'high', slot: 'morning' },
  ...
  dataEntry: {
    ...
    symptomName: '탈모',
    nameEn: 'Hair Loss (Alopecia)',
    bodyPart: 'scalp',
    severity: 'low',
    hasEmergency: false,
    relatedOtc: [],
    relatedSupplements: ['iron', 'zinc', 'vitamin-b-complex'],
    relatedSituation: null,
    relatedTool: null,
    relatedSlugs: ['menopause-symptoms'],
  },

  postContent: `// posts/symptoms/hair-loss.js
const post = {
  id: 'S0012',
  sections: [
    {
