...
// entity: symptoms | slug: hantavirus | priority: high | slot: morning
'use strict'

module.exports = {
  meta: { entity: 'symptoms', dataId: 'S0006', slug: 'hantavirus', priority: 'high', slot: 'morning' },
  ...
  postContent: `// posts/symptoms/hantavirus.js
const post = {
  id: 'S0006',
  sections: [
    {
