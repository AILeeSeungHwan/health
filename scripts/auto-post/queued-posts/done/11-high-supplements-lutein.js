...
// entity: supplements | slug: lutein | priority: high | slot: noon
'use strict'

module.exports = {
  meta: { entity: 'supplements', dataId: 'U0007', slug: 'lutein', priority: 'high', slot: 'noon' },
  ...
  postContent: `// posts/supplements/lutein.js
const post = {
  id: 'U0007',
  sections: [
    {
