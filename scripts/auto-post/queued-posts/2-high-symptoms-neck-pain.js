...
// entity: symptoms | slug: neck-pain | priority: high | slot: morning
'use strict'

module.exports = {
  meta: { entity: 'symptoms', dataId: 'S0007', slug: 'neck-pain', priority: 'high', slot: 'morning' },
  ...
  postContent: `// posts/symptoms/neck-pain.js
const post = {
  id: 'S0007',
  sections: [
    {
