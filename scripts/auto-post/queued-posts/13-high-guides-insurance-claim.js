...
// entity: guides | slug: medical-insurance-claim | priority: high | slot: morning
'use strict'

module.exports = {
  meta: { entity: 'guides', dataId: 'G0005', slug: 'medical-insurance-claim', priority: 'high', slot: 'morning' },
  ...
  postContent: `// posts/guides/medical-insurance-claim.js
const post = {
  id: 'G0005',
  sections: [
    {
