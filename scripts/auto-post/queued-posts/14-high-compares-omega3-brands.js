...
// entity: compares | slug: omega3-brands | priority: high | slot: evening
'use strict'

module.exports = {
  meta: { entity: 'compares', dataId: 'C0002', slug: 'omega3-brands', priority: 'high', slot: 'evening' },
  ...
  postContent: `// posts/compares/omega3-brands.js
const post = {
  id: 'C0002',
  sections: [
    {
