...
const situations = [
  {
    ...
    includedOtc: ['tylenol-acetaminophen', 'ibuprofen', 'naproxen'],
  ...
  },
  {
    ...
    description: '불면의 원인부터 수면 위생 원칙, 마그네슘·멜라토닉 등 도움될 수 있는 영양제, 만성 불면 시 의료 상담이 필요한 신호까지 정리합니다.',
    category: 'situation',
    ymylLevel: 'A',
    medicallyReviewed: false,
    author: 'healthmoa',
    ...
    includedOtc: [],
    includedSupplements: ['magnesium', 'calcium-magnesium'],
    includedProducts: [],
    includedGuides: [],
    relatedTools: ['sleep-debt'],
  ...
  },
  {
    ...
    includedSymptoms: [],
    includedOtc: [],
    includedSupplements: ['vitamin-d', 'omega-3', 'probiotics', 'vitamin-c-liposomal', 'multivitamin'],
    includedProducts: [],
    includedGuides: [],
    relatedTools: [],
    relatedSlugs: ['sleep-issue'],
  },
  {
    ...
    includedOtc: ['ibuprofen', 'naproxen'],
    includedSupplements: ['magnesium', 'curcumin', 'chondroitin', 'collagen'],
    includedProducts: [],
    includedGuides: [],
    relatedTools: [],
  ...
  },
  {
    ...
    includedSymptoms: [],
    includedOtc: [],
    includedSupplements: ['omega-3', 'blood-sugar-care', 'multivitamin', 'calcium-magnesium'],
    includedProducts: [],
